...
# Enter ordinate axis data and abscissa axis data
...
# 4 plot functions draw 4 lines, the line shape is a broken line, each line corresponds to its own label label
...
plt.xticks(alpha)  # Set the abscissa scale
...
# # Save the file to the file and draw the picture
plt.legend(prop={'size': 14}) # Show the legend, that is, each line corresponds to the content in the label
...
#
# plt.xticks(epochs)  # Set the abscissa scale
# plt.xticks(fontsize=13)
# plt.yticks(fontsize=13)
# font2 = {'family': 'Times New Roman',
#          'weight': 'normal',
